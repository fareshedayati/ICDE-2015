...
operations, such as dot product, and low memory footprints.
...
samples to split. Leaves are labeled by the outpu mean in regression or by the
class frequencies in classification with reaching training samples. Predictions
will be made by aggregating the prediction of each tree of the ensemble.
